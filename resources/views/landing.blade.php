...
<body class="bg-gray-950 text-white min-h-screen overflow-x-hidden">
   ...
   {{-- SECTION KONSER POPULER --}}
    ...
    <div class="w-full bg-pink-600 text-white py-3.5 overflow-hidden shadow-md my-6">
        ...
        <div class="flex flex-col md:flex-row items-center justify-between gap-8 text-center md:text-left">
            ...
            <div>
                ...
                <div class="flex justify-center md:justify-end gap-3">
                    ...
                    <!-- Link X / Twitter -->
                    <a href="#" class="w-10 h-10 bg-gray-900 border border-gray-800 hover:border-pink-500 hover:text-pink-400 rounded-xl flex items-center justify-center transition-all hover:scale-110">
